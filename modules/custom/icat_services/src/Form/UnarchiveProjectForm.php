 ...
 */
class UnarchiveProjectForm extends ConfirmFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return "unarchive_project_form";
  }
  ...
  public function getQuestion() {
    return t('Do you want to unarchive?');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message('Unarchive successfully.');
